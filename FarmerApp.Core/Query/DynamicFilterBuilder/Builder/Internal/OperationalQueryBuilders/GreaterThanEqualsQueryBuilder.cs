...
internal class GreaterThanEqualsQueryBuilder : IOperationalQueryBuilder
{
    public static readonly GreaterThanEqualsQueryBuilder Instance = new();

    private GreaterThanEqualsQueryBuilder()
    {
    }
    ...
    public Expression Build(Type propertyType, Expression propertyExpression, string filterValue)
    {
        ...
        var result = Expression.GreaterThanOrEqual(propertyExpression, filterValueExpression);
